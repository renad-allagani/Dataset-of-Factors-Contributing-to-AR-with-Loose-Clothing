...
2-The second file consists of dataset collected with the scotch yoke and KUKA manipulator, in addition to the SVM frequency classification MATLAB script, results script.  

The following key folders and files are in path: Dataset/libsvm-3.31/matlab   
...
Results reported in proceeding: 
